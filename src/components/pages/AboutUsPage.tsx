...
import { Col, Flex, Headline, Paragraph, ResponsiveWrap, Row, Text } from '../lib'
					...
					<Col $gap={'4rem'}>
						<Row $width={'60%'}>
							<Paragraph>
								...
								histopatologická laboratoř, která Vám zaručí rychlé a dostupné vyšetření. Dohromady se diagnostické
								praxi věnujeme téměř třicet let!
							</Paragraph>
						</Row>
						<Person
